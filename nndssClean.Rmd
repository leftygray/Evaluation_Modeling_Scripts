...
cascadeDataFolder <- file.path("C:", "Users", "rgray", "UNSW",
  "Australian Care Cascades - Documents", "OtherSTIs")
...
# Merge notifications
ngMSMdiags <- tibble(year = years,
  male = ngTotal$n,
  cities = ngMajorCities$n,
  regions = ngOther$n,
  missing = ngMissing$n)
...
write.csv(ngMSMdiags, file = file.path(cascadeDataFolder, "Gonorrhoea",
  paste0("gbmNGnotifications-", dataYear, ".csv")), 
  row.names = FALSE)
