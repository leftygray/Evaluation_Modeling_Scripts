...
- Permanent and Long-term departures: Sum of the three previous variables. Since
2016 this is just LTRD + LTVD. 

Note: dataYear in the file refers to the last complete year in the data. These
statistics report on the number of international border crossings rather than
the number of people. So technically isn't the same as overseas migration. 
