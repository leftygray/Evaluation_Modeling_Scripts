...
# rawDataFile <- file.path(rawDataDirectory, 
#   paste0("rawHIVnotifications-", toString(yearAnalysis), ".dta"))
rawDataFile <- file.path(rawDataDirectory, "2017_NHR_FULL - Backup.dta")
...
vars <- c("state", "postcode", "sex", "dob", "cob", "rob", "datehiv",
