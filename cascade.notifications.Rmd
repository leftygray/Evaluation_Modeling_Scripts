...
rawDataFile <- file.path("/", "SVR-NAS", "Public", "SERP", "Cascades", 
                         "HIV", "data", "National Registry Data",   
                         paste0("rawHIVnotifications-", 
                                toString(yearAnalysis), ".dta"))

# De-identified output file name
cleanDataFile <- file.path("/", "SVR-NAS", "Public", "SERP", "Cascades",  
                           "HIV", "data", 
                           paste0("cascadeHIVnotifications-",
                                  toString(yearAnalysis), 
                                  ".csv"))

cleanDataFileBP <- file.path("/", "SVR-NAS", "Public", "SERP", "Cascades", 
                             "HIV", "data", 
                             paste0("backprojectionHIVnotifications-",                                                 toString(yearAnalysis), ".csv"))
