...
# Key folder paths
privateDataPath <- file.path("/", "SVR-NAS", "Public", "SERP", "Cascades",
                             "HIV", "data")
...
rawdata <- file.path(privateDataPath, paste0("cascadeHIVnotifications-", 
