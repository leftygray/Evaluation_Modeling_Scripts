...
## Prospection PharmDash HIV Treatment Data (DEPRECATED)

Description of the output from Prospection and the cleaning process. This 
is now deprecated as we are getting 100% PBS data now directly from the 
department of health since 2019. 

```{r Prospection (DEPRECATED)}
...
if (dataYear <= 2018) {
  ...
  print("DEPRECATED - Prospection data no longer used from 2019") 
