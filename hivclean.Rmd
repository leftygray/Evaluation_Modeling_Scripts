...
if (dataYear < 2015) {
  ...
  hivdata[which(hivdata$cob != 1100 | hivdata$rob != 7),]$aboriggroup <-
    "othercob"
  hivdata[which(hivdata$cob == 0),]$aboriggroup <- NA
  hivdata[which(hivdata$cob == 1100 & hivdata$indigenous == "Indigenous"),
          ]$aboriggroup <- "indigenous"
  hivdata[which(hivdata$cob == 1100 & hivdata$indigenous == "Non indigenous"),
          ]$aboriggroup <- "non-indigenous"
}
  
# Save cleaned hivdata
write.csv(hivdata, file = file.path(cleanDataFolder,
                              paste("hivnotifications",
                                    toString(dataYear), ".csv", 
                                    sep ="")), row.names = FALSE)
